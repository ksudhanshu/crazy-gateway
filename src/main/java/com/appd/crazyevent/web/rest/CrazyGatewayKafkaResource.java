...
@RestController
@RequestMapping("/api/crazy-gateway-kafka")
public class CrazyGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CrazyGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CrazyGatewayKafkaResource(KafkaProperties kafkaProperties) {
